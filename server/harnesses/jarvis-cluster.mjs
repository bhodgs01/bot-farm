...
export const ROSTER = [
  ...
  { id: 'clawd',   name: 'Clawd',   emoji: '🦞', role: 'chaos gremlin',        zone: 'KC Proto',        landmark: 'hq',          ns: ['clawd-dashboard'],                                           url: 'https://agents.kcproto.com/clawd-chat.html', probe: process.env.CLAWD_PROBE || '' },
  { id: 'frances', name: 'Frances', emoji: '🩺', role: 'caregiver AI',         zone: 'Frances',           landmark: 'apartment', ns: ['caregiver'],                                                 url: 'https://caregiver.kcproto.com' },
  { id: 'grader',  name: 'Grader',  emoji: '🧮', role: 'compliance grader',    zone: 'CyberGrade', landmark: 'shield',        ns: ['cybergrade', 'cybergrade-api'],                              url: '' },
  { id: 'plex',    name: 'Blakeflix', emoji: '📺', role: 'media server',       zone: 'Blakeflix',            landmark: 'theater',              ns: ['plex'],                                                      url: 'https://app.plex.tv/desktop' },
  { id: 'core',    name: 'Core',    emoji: '🛰️', role: 'control plane',        zone: 'Cluster',           ns: ['kube-system'],                                               url: 'https://grafana.kcproto.com', landmark: 'controltower' },
  { id: 'house',   name: 'House',   emoji: '🏠', role: 'home assistant',       zone: 'Home',              ns: ['home-assistant'],                                            url: 'https://homeassistant.kcproto.com', landmark: 'house' },
  { id: 'biff',    name: 'Biff',    emoji: '🧑‍💼', role: 'club operations',      zone: 'KC AI Club',      landmark: 'clubhouse',        ns: ['aiclub'],                                                    url: 'https://ai-club.kcproto.com/#/biff' },
  { id: 'marc',    name: 'Marc',    emoji: '🌿', role: 'landscape ops',        zone: 'Embassy Landscape', landmark: 'yard', ns: ['marc', 'aspire-portal', 'irrigation-mapper', 'inspire-fallback'], url: 'https://inspire.kcproto.com' },
  { id: 'rusty',   name: 'Rusty',   emoji: '⛽', role: 'oil wells',            zone: 'CorrosionDC',       landmark: 'pumpjack', ns: ['corrosiondc'],                                               url: 'https://wellz.kcproto.com' },
  { id: 'olga',    name: 'Olga',    emoji: '🧑‍🏫', role: 'recruit intel',        zone: 'NGV Talent', landmark: 'recruitdesk',        ns: ['recruit-intel', 'recruiter-bot', 'recruit-form', 'ngv-sales'], url: 'https://recruiter-bot.kcproto.com' },
  ...
  { id: 'snoop',   name: 'Snoop',   emoji: '📈', role: 'trader',               zone: 'Trade Floor',     landmark: 'tradingfloor',      ns: [],  url: 'https://trade-bot.kcproto.com', probe: 'https://trade-bot.kcproto.com/api/health' },
  { id: 'gordon',  name: 'Gordon',  emoji: '👨‍🍳', role: 'schema roast',         zone: 'Roast Bot', landmark: 'grill',      ns: ['roast-bot'],                                                 url: 'https://schemacheckerai.com' },
]
...
function brainFeedThreads(snap) {
  ...
  for (const pod of snap.pods.get(BRAIN_NS) || []) {
    ...
    out.push({
      ...
      routine: feed,
      prState: '',
      kind: phase === 'Succeeded' ? 'info' : undefined,
      archived: false,
      hasTranscript: true,
